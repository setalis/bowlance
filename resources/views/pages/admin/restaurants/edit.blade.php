...
@section('content')
    <x-common.page-breadcrumb pageTitle="Редактировать ресторан">
        <x-slot:breadcrumbs>
            <li>
            ...
            <li>
                <span class="text-gray-700 dark:text-gray-400">Редактировать ресторан</span>
            </li>
        </x-slot:breadcrumbs>
    ...
    @can('restaurant.update')
        <div class="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-gray-dark md:p-6">
            ...
            <form method="POST" action="{{ route('admin.restaurants.update', $restaurant) }}" class="space-y-6">
                @csrf
                @method('PUT')
    ...
    @else
        <div class="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-gray-dark md:p-6">
            <x-ui.alert variant="error" message="У вас нет прав для редактирования ресторанов." />
        </div>
    @endcan
@endsection
