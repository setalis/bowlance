...
@endphp
    <x-common.page-breadcrumb pageTitle="Редактировать категорию блюд">
        <x-slot:breadcrumbs>
            <li>
    ...
    <div class="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-gray-dark md:p-6">
        ...
        <form method="POST" action="{{ route('admin.dish-categories.update', $category) }}" enctype="multipart/form-data" class="space-y-4">
            @csrf
            @method('PUT')
            ...
            <div class="grid gap-4 md:grid-cols-1">
                ...
                <div>
                    ...
                    @if($category->image)
                        <div class="mb-3">
                            <img src="{{ Storage::url($category->image) }}" alt="{{ $category->name }}" class="h-32 w-32 rounded-lg object-cover">
