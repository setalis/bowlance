...
@section('content')
    <x-common.page-breadcrumb pageTitle="Добавить блюдо">
        <x-slot:breadcrumbs>
            <li>
            ...
            <li>
                <span class="text-gray-700 dark:text-gray-400">Добавить блюдо</span>
            </li>
        </x-slot:breadcrumbs>
    ...
    <div class="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-gray-dark md:p-6"
        x-data="{
            ...
            async submitForm(event) {
                ...
                try {
                    const response = await fetch('{{ route('admin.dishes.store') }}', {
                        method: 'POST',
                        body: formData,
                        headers: {
        ...
        <form @submit="submitForm" method="POST" action="{{ route('admin.dishes.store') }}" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="flex flex-col gap-4 sm:flex-row sm:justify-end">
                ...
                <button type="submit" 
                    ...
                    <span x-show="!loading">Создать блюдо</span>
