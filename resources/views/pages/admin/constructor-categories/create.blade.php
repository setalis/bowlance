...
@section('content')
    <x-common.page-breadcrumb pageTitle="Добавить категорию конструктора">
        <x-slot:breadcrumbs>
            <li>
    ...
    <div class="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-gray-dark md:p-6">
        <div class="mb-6">
            <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90">
                Создание новой категории конструктора
            </h3>
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                Заполните форму для добавления новой категории конструктора в систему
            </p>
        </div>

        <form method="POST" action="{{ route('admin.constructor-categories.store') }}" class="space-y-4">
            @csrf
