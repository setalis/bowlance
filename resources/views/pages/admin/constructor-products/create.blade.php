...
@section('content')
    <x-common.page-breadcrumb pageTitle="Добавить продукт конструктора">
        <x-slot:breadcrumbs>
            <li>
            ...
            <li>
                <span class="text-gray-700 dark:text-gray-400">Добавить продукт</span>
            </li>
        </x-slot:breadcrumbs>
    ...
    <div class="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-gray-dark md:p-6">
        <div class="mb-6">
            <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90">
                Создание нового продукта конструктора
            </h3>
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                Заполните форму для добавления нового продукта конструктора в систему
            </p>
        </div>

        <form method="POST" action="{{ route('admin.constructor-products.store') }}" enctype="multipart/form-data" class="space-y-4">
            @csrf
